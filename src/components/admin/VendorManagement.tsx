            ...
            <table className="w-full min-w-[600px] sm:min-w-[700px] md:min-w-[800px] table-auto">
              <thead className="h-12">
                <tr className="border-b border-[#1a2624]/10">
                  ...
                  <th className="text-left px-3 font-normal text-sm text-[#2a2e35] font-['Poppins'] leading-tight hidden md:table-cell">
                    Tags
                  </th>
              ...
              {loading ? (
                ...
                filteredVendors.map((vendor, index) => (
                  ...
                  >
                    ...
                    <td className="px-3 max-w-[360px] hidden md:table-cell">
                      <div className="flex flex-wrap gap-1">
                        {vendor.tags?.map((tag) => (
                          <span key={tag} className="px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full">
                            {tag}

...
const UploadDocumentDialog: React.FC<UploadDocumentDialogProps> = ({
  ...
  // Early return with error boundary if critical dependencies are missing
  if (open && !projectId) {
    console.error('UploadDocumentDialog: No project ID available');
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Unable to load upload dialog. Project information is missing.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
  ...
  const uploadFileAndCreateDocument = async (file: File, title: string, taskId?: string): Promise<void> => {
    if (!projectId) {
